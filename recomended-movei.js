...
pictureMovieBotton.onclick=function(){
    ...
    Title2.innerText='2.Dinner ダイナー';
...
musicalMovieBotton.onclick=function(){
    ...
    Sentence2.innerText='監督：ロバート・ワイズ\n主演：ジュリー・アンドリュース\n\　n大ヒットブロードウェイ・ミュージカルで、王道ミュージカル映画の一つ。1938年のオーストリアで、厳格なトラップ家へ家庭教師としてやって来た修道女の物語。有名な曲ばかりで、歌の素晴らしさを感じることができる作品です。私は特に「ひとりぼっちの羊飼い」を歌うシーンが大好きです。';
}
...
ConanMovieButton.onclick=function(){
    ...
    Title2.innerText='2.名探偵コナン　ハロウィンの花嫁';
